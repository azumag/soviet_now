...
TYPE_BONUS = {
    ...
    14: 5760,
    15: 12096,
    # type 16 = ソ連。表は隣接比 2.1 の等比なので 12096 × 2.1 = 25402。
    # これが無いと「T15 を 2 個持ったまま終局」(2×12096=24192) より
    # 「実際に建国」(raw +136、soviet ボーナス +800) のほうが 23,256 点低く評価され、
    # 自動探索・回帰判定が最終目標を回避する向きに働く (issue #132 P0-0)。
    16: 25402,
}
