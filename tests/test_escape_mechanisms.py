...
class TestCommentReplyDepthPrompt(unittest.TestCase):
    ...
    def test_deadline_guard_does_not_gate_merge_preference_on_global_merge(self):
        strategy_src = (REPO_ROOT / "strategy.py").read_text()

        self.assertNotIn("__dlg_deadline_crossed and __dlg_global_merge", strategy_src)
        self.assertNotIn("force NO_MERGE by skipping __dlg_merge_preferred", strategy_src)
    ...
    def test_pre_russia_t12_consolidate_feeds_low_type_to_t12_lane(self):
        import strategy

        pieces = [
            {"id": 1, "type": 12, "x": -0.72, "y": -2.74},
            {"id": 2, "type": 12, "x": 2.52, "y": -1.12},
            {"id": 3, "type": 11, "x": 0.18, "y": 0.11},
            {"id": 4, "type": 10, "x": -1.04, "y": 0.95},
            {"id": 5, "type": 10, "x": 1.18, "y": -0.85},
            {"id": 6, "type": 10, "x": 1.64, "y": -3.81},
            {"id": 7, "type": 7, "x": 0.6, "y": -1.2},
            {"id": 8, "type": 7, "x": 2.55, "y": 0.3},
        ]
        for i in range(9, 34):
            pieces.append(
                {
    ...
    def test_pre_russia_t12_abundance_pair_lock_feeds_t9_ladder_before_redline(self):
        import strategy

        pieces = [
            {"id": 1, "type": 12, "x": -0.55, "y": -3.7},
            {"id": 2, "type": 12, "x": 0.85, "y": -1.9},
            {"id": 3, "type": 12, "x": -2.1, "y": -0.2},
            {"id": 4, "type": 12, "x": -0.95, "y": 1.45},
            {"id": 5, "type": 11, "x": 1.7, "y": -1.2},
            {"id": 6, "type": 10, "x": -0.7, "y": 0.8},
            {"id": 7, "type": 9, "x": -0.35, "y": -1.0},
            {"id": 8, "type": 9, "x": 2.35, "y": 1.35},
        ]
        for i in range(9, 36):
            pieces.append(
                {
    ...
    def test_pre_russia_single_t13_no_t12_rebuild_keeps_t11_near_t13_lane(self):
        import strategy

        pieces = [
            {"id": 1, "type": 13, "x": -1.20, "y": -3.42},
            {"id": 2, "type": 10, "x": -1.61, "y": -1.73},
            {"id": 3, "type": 9, "x": -1.29, "y": 0.21},
            {"id": 4, "type": 9, "x": 1.71, "y": -2.58},
            {"id": 5, "type": 9, "x": 2.82, "y": -3.22},
            {"id": 6, "type": 8, "x": -0.67, "y": -1.20},
            {"id": 7, "type": 8, "x": 0.54, "y": -2.45},
        ]
        for i in range(8, 24):
            pieces.append(
                {
        ...
        self.assertIn("PRE_RUSSIA_SINGLE_T13_NO_T12_REBUILD", decision["reason"])

    def test_pre_russia_single_t13_no_t12_rebuild_feeds_low_type_to_rebuild_lane(self):
        import strategy

        pieces = [
            {"id": 1, "type": 13, "x": -1.2, "y": -3.2},
            {"id": 2, "type": 11, "x": -1.55, "y": -0.8},
            {"id": 3, "type": 11, "x": 1.7, "y": -2.2},
            {"id": 4, "type": 10, "x": -0.9, "y": -1.6},
            {"id": 5, "type": 9, "x": -1.3, "y": 0.3},
            {"id": 6, "type": 7, "x": -1.05, "y": -0.9},
            {"id": 7, "type": 7, "x": 2.45, "y": 0.2},
        ]
        for i in range(8, 30):
            pieces.append(
                {
        ...
        decision = strategy.decide(
            ...
            {
                "reactor": {"deadline_margin": 1.7, "reactive_pairs": []},
                "results": [
                    {
                        "x": -1.05,
                        "crosses_deadline": False,
    ...
    def test_pre_russia_single_t13_no_t12_rebuild_starts_on_early_t9_pair(self):
        import strategy

        pieces = [
            {"id": 1, "type": 13, "x": 0.1, "y": -3.2},
            {"id": 2, "type": 9, "x": -0.55, "y": -2.2},
            {"id": 3, "type": 9, "x": -0.85, "y": -3.4},
            {"id": 4, "type": 6, "x": -0.35, "y": -1.0},
            {"id": 5, "type": 6, "x": 2.35, "y": -0.2},
        ]
        for i in range(6, 14):
            pieces.append(
                {
        ...
        decision = strategy.decide(
            ...
            {
                "reactor": {"deadline_margin": 2.6, "reactive_pairs": []},
                "results": [
                    {
                        "x": -0.35,
                        "crosses_deadline": False,
    ...
    def test_pre_russia_single_t13_t12_compress_feeds_low_type_to_t12_bank(self):
        import strategy

        pieces = [
            {"id": 1, "type": 13, "x": 0.75, "y": -0.45},
            {"id": 2, "type": 12, "x": -2.6, "y": -0.9},
            {"id": 3, "type": 12, "x": -0.25, "y": -3.7},
            {"id": 4, "type": 11, "x": 1.8, "y": -3.2},
            {"id": 5, "type": 11, "x": 2.3, "y": 0.0},
            {"id": 6, "type": 10, "x": -2.35, "y": 1.0},
            {"id": 7, "type": 10, "x": -0.7, "y": 1.1},
            {"id": 8, "type": 9, "x": -1.2, "y": 0.5},
            {"id": 9, "type": 7, "x": -1.25, "y": -1.1},
            {"id": 10, "type": 7, "x": 2.6, "y": 0.2},
        ]
    ...
    def test_pre_russia_single_t13_t12_compress_prefers_t12_bank_over_t13_side(self):
        import strategy

        pieces = [
            {"id": 1, "type": 13, "x": 2.3, "y": -0.9},
            {"id": 2, "type": 12, "x": -2.65, "y": -1.05},
            {"id": 3, "type": 12, "x": -1.14, "y": 1.39},
            {"id": 4, "type": 12, "x": 0.07, "y": -3.7},
            {"id": 5, "type": 12, "x": 2.63, "y": 1.5},
            {"id": 6, "type": 11, "x": -0.28, "y": -0.35},
            {"id": 7, "type": 11, "x": 2.3, "y": -3.23},
            {"id": 8, "type": 10, "x": 0.3, "y": -1.45},
        ]
        for i in range(9, 40):
            pieces.append(
                {
        ...
        decision = strategy.decide(
            ...
            {
                "reactor": {"deadline_margin": 0.35, "reactive_pairs": []},
                "results": [
                    {
                        "x": -0.28,
                        "crosses_deadline": True,
        ...
        self.assertEqual(decision["x"], -0.28)
        self.assertIn("PRE_RUSSIA_SINGLE_T13_T12_COMPRESS", decision["reason"])

    def test_pre_russia_single_t13_t12_compress_rebuilds_near_split_t13_lane(self):
        import strategy

        pieces = [
            {"id": 1, "type": 13, "x": -0.76, "y": -3.0},
            {"id": 2, "type": 12, "x": 1.26, "y": -2.58},
            {"id": 3, "type": 12, "x": 2.55, "y": 0.08},
            {"id": 4, "type": 11, "x": -1.56, "y": 0.30},
            {"id": 5, "type": 11, "x": 2.18, "y": -1.39},
            {"id": 6, "type": 10, "x": -2.0, "y": -3.45},
            {"id": 7, "type": 10, "x": 1.10, "y": 0.83},
            {"id": 8, "type": 9, "x": -2.58, "y": 0.1},
            {"id": 9, "type": 9, "x": -1.06, "y": -1.85},
            {"id": 10, "type": 9, "x": 1.96, "y": -3.79},
        ]
    ...
    def test_pre_russia_single_t13_t12_compress_rebuilds_low_side_when_t12_pair_split_wide(self):
        import strategy

        pieces = [
            {"id": 1, "type": 13, "x": 1.46, "y": -2.94},
            {"id": 2, "type": 12, "x": -1.63, "y": -2.56},
            {"id": 3, "type": 12, "x": 2.20, "y": -1.09},
            {"id": 4, "type": 11, "x": 1.05, "y": -0.20},
            {"id": 5, "type": 10, "x": -2.66, "y": -1.69},
            {"id": 6, "type": 10, "x": -2.64, "y": 0.67},
            {"id": 7, "type": 10, "x": -0.88, "y": 0.49},
            {"id": 8, "type": 9, "x": -0.69, "y": -0.77},
        ]
        for i in range(9, 39):
            pieces.append(
                {
    ...
    def test_pre_russia_single_t13_t12_compress_uses_low_t11_bridge_when_t12_pair_vertical_split(self):
        import strategy

        pieces = [
            {"id": 1, "type": 13, "x": -1.10, "y": 1.15},
            {"id": 2, "type": 12, "x": 1.85, "y": -2.55},
            {"id": 3, "type": 12, "x": 2.15, "y": 1.40},
            {"id": 4, "type": 11, "x": 0.41, "y": -1.82},
            {"id": 5, "type": 10, "x": -2.38, "y": -0.55},
            {"id": 6, "type": 9, "x": 2.82, "y": -3.22},
            {"id": 7, "type": 9, "x": 2.37, "y": -0.84},
            {"id": 8, "type": 9, "x": -0.03, "y": -0.87},
        ]
        for i in range(9, 35):
            pieces.append(
                {
    ...
    def test_pre_russia_single_t13_single_t12_ladder_feeds_t9_to_t12_lane(self):
        import strategy

        pieces = [
            {"id": 1, "type": 13, "x": 0.15, "y": -2.9},
            {"id": 2, "type": 12, "x": -1.25, "y": -1.6},
            {"id": 3, "type": 10, "x": -0.8, "y": -2.4},
            {"id": 4, "type": 10, "x": 1.85, "y": -0.8},
            {"id": 5, "type": 9, "x": -0.95, "y": -1.3},
            {"id": 6, "type": 9, "x": 2.35, "y": -0.2},
        ]
        for i in range(7, 26):
            pieces.append(
                {
        ...
        self.assertEqual(decision["x"], -0.95)
        self.assertIn("PRE_RUSSIA_SINGLE_T13_SINGLE_T12_LADDER", decision["reason"])
    ...
    def test_pre_russia_t13_pair_ladder_feeds_low_type_to_pair_lane(self):
        import strategy

        pieces = [
            {"id": 1, "type": 13, "x": 0.28, "y": -2.35},
            {"id": 2, "type": 13, "x": 0.72, "y": 0.5},
            {"id": 3, "type": 11, "x": -1.6, "y": -2.55},
            {"id": 4, "type": 10, "x": -2.55, "y": -2.2},
            {"id": 5, "type": 10, "x": -1.05, "y": -0.2},
            {"id": 6, "type": 10, "x": -0.25, "y": -3.75},
            {"id": 7, "type": 7, "x": 0.55, "y": -1.1},
            {"id": 8, "type": 7, "x": 2.55, "y": 0.4},
        ]
        for i in range(9, 38):
            pieces.append(
                {
        ...
        decision = strategy.decide(
            ...
            {
                "reactor": {"deadline_margin": 1.45, "reactive_pairs": []},
                "results": [
                    {
                        "x": 0.55,
                        "crosses_deadline": False,
        ...
        self.assertEqual(decision["x"], 0.55)
        self.assertIn("PRE_RUSSIA_T13_PAIR_LADDER", decision["reason"])

    def test_pre_russia_t13_pair_ladder_ignores_far_t11_bank_without_t12s(self):
        import strategy

        pieces = [
            {"id": 1, "type": 13, "x": 0.3, "y": -2.35},
            {"id": 2, "type": 13, "x": 0.7, "y": 0.5},
            {"id": 3, "type": 11, "x": -1.6, "y": -2.55},
            {"id": 4, "type": 10, "x": -2.55, "y": -2.2},
            {"id": 5, "type": 10, "x": -1.05, "y": -0.2},
            {"id": 6, "type": 10, "x": -0.25, "y": -3.75},
        ...
        decision = strategy.decide(
            ...
            {
                "reactor": {"deadline_margin": 1.35, "reactive_pairs": []},
                "results": [
                    {
                        "x": 0.5,
                        "crosses_deadline": False,
        ...
        self.assertEqual(decision["x"], 0.5)
        self.assertIn("PRE_RUSSIA_T13_PAIR_LADDER", decision["reason"])
    ...
    def test_pre_russia_single_t12_anchor_ladder_pulls_t9_density_to_anchor(self):
        import strategy

        pieces = [
            {"id": 1, "type": 12, "x": 0.84, "y": -0.38},
            {"id": 2, "type": 11, "x": 1.51, "y": -3.32},
            {"id": 3, "type": 10, "x": -2.73, "y": 0.07},
            {"id": 4, "type": 10, "x": 0.78, "y": 1.06},
            {"id": 5, "type": 10, "x": 1.47, "y": -2.16},
            {"id": 6, "type": 9, "x": -1.41, "y": -3.27},
            {"id": 7, "type": 9, "x": -1.41, "y": 0.48},
            {"id": 8, "type": 9, "x": -1.14, "y": -1.50},
            {"id": 9, "type": 9, "x": 2.35, "y": -0.93},
            {"id": 10, "type": 8, "x": -0.28, "y": -2.13},
            {"id": 11, "type": 8, "x": 0.49, "y": -3.76},
        ]
    ...
    def test_pre_russia_single_t12_anchor_ladder_starts_on_early_t9_t10_density(self):
        import strategy

        pieces = [
            {"id": 1, "type": 12, "x": -2.0, "y": -1.9},
            {"id": 2, "type": 11, "x": 1.8, "y": -1.3},
            {"id": 3, "type": 10, "x": -2.15, "y": -3.7},
            {"id": 4, "type": 10, "x": 1.05, "y": -2.1},
            {"id": 5, "type": 10, "x": 2.25, "y": -3.7},
            {"id": 6, "type": 9, "x": -0.15, "y": -2.9},
            {"id": 7, "type": 9, "x": 2.3, "y": -2.6},
        ]
        for i in range(8, 20):
            pieces.append(
                {
        ...
        decision = strategy.decide(
            ...
            {
                "reactor": {"deadline_margin": 3.2, "reactive_pairs": []},
                "results": [
                    {
                        "x": -2.0,
                        "crosses_deadline": False,
    ...
    def test_pre_russia_single_t12_anchor_ladder_feeds_low_type_to_anchor(self):
        import strategy

        pieces = [
            {"id": 1, "type": 12, "x": -1.9, "y": -1.8},
            {"id": 2, "type": 11, "x": 1.75, "y": -1.2},
            {"id": 3, "type": 10, "x": -2.1, "y": -3.7},
            {"id": 4, "type": 10, "x": 1.0, "y": -2.0},
            {"id": 5, "type": 10, "x": 2.2, "y": -3.6},
            {"id": 6, "type": 8, "x": -1.8, "y": -0.9},
            {"id": 7, "type": 8, "x": 2.35, "y": -0.2},
            {"id": 8, "type": 9, "x": -0.25, "y": -2.9},
            {"id": 9, "type": 9, "x": 2.25, "y": -2.5},
        ]
...
class TestSovietObjectiveImproveInputs(unittest.TestCase):
    ...
    def test_deadline_safety_rejects_pre_russia_t13_pair_lane_at_hard_deadline(self):
        ...
        pieces = [
            {"id": 1, "type": 13, "x": -0.71, "y": -3.09, "r": 1.235},
            {"id": 2, "type": 13, "x": -0.85, "y": -0.74, "r": 1.235},
            {"id": 3, "type": 12, "x": 1.91, "y": 0.07, "r": 1.068},
            {"id": 4, "type": 12, "x": -2.57, "y": 0.06, "r": 1.068},
            {"id": 5, "type": 11, "x": -0.24, "y": 1.99, "r": 0.982},
            {"id": 6, "type": 10, "x": -1.35, "y": 0.80, "r": 0.846},
            {"id": 7, "type": 10, "x": 1.48, "y": 1.41, "r": 0.846},
            {"id": 8, "type": 10, "x": -2.67, "y": -2.75, "r": 0.846},
        ]
        for i in range(9, 42):
            pieces.append(
                {
        ...
        decision = strategy_runner.enforce_deadline_safety(
            {"x": -1.35, "reason": "DEADLINE_GUARD_FIRST_RUSSIA_PAIR"},
            {
                "deadline": {
                    "deadline_y": 3.38,
                    "top_edge_y": 3.33,
                ...
                "reactor": {"reactive_pairs": [1, 2, 3, 4, 5]},
                "results": [
                    {
                        "x": -1.35,
                        "crosses_deadline": True,
                    ...
                    },
                    {
                        ...
                        "crosses_deadline": False,
                        "merge_grade": "NO",
                        "risk_top_y_after_drop": 2.17,
                    },
                    {
                        "x": 2.3,
                        "crosses_deadline": False,
                        "merge_grade": "NO",
                        "risk_top_y_after_drop": 2.68,
                    },
                    {
                        "x": -2.8,
                        "crosses_deadline": False,
        ...
        self.assertNotEqual(decision["x"], -1.35)
        self.assertIn("deadline_headroom", decision["reason"])

    def test_deadline_safety_rejects_single_t13_t12_compress_lane_at_hard_deadline(self):
        import strategy_runner

        pieces = [
            {"id": 1, "type": 13, "x": -0.86, "y": -0.57, "r": 1.235},
            {"id": 2, "type": 12, "x": 0.61, "y": -2.72, "r": 1.068},
            {"id": 3, "type": 12, "x": -2.52, "y": 0.77, "r": 1.068},
            {"id": 4, "type": 12, "x": -2.65, "y": -2.50, "r": 1.068},
            {"id": 5, "type": 11, "x": 0.61, "y": 1.61, "r": 0.982},
            {"id": 6, "type": 10, "x": -1.02, "y": 1.28, "r": 0.846},
            {"id": 7, "type": 10, "x": 1.10, "y": -3.63, "r": 0.846},
        ]
        for i in range(8, 38):
            pieces.append(
                {
        ...
        decision = strategy_runner.enforce_deadline_safety(
            {
                ...
                "reason": (
                    "NO_MERGE_CROSSES_DEADLINE_PENALTY_HIGH_TOWER_"
                    "PRE_RUSSIA_SINGLE_T13_T12_COMPRESS"
                ),
            },
            {
                "deadline": {
        ...
        self.assertEqual(decision["x"], 2.8)
        self.assertNotIn("pre_russia_single_t13_t12_lane", decision["reason"])
