...
start_radio_talk() {
	...
	(
		...
		local themes=(
			...
			# --- スポーツ（細分化） ---
			"マラドーナの神の手の話。1986年W杯、5人抜きゴール、アルゼンチンの英雄と破滅的な人生を深掘りして"
			"ボルトの9.58秒の話。人類最速、100m世界記録、靴紐がほどけたまま走った北京五輪を深掘りして"
			"サッカーW杯1998年フランス大会の話。ジダンの2ゴール、多民族国家フランスの団結を深掘りして"
			"井上尚弥の話。モンスター、4団体統一、パウンドフォーパウンド、日本ボクシング史上最強を深掘りして"
			"大谷翔平の二刀流の話。なぜ100年不可能と言われたか、ベーブ・ルース以来、野球の常識を壊した男を深掘りして"
			"箱根駅伝の話。日本だけの大学駅伝文化、山の神、繰り上げスタートの涙、正月の国民行事を深掘りして"
			# --- インターネット文化（新カテゴリ） ---
