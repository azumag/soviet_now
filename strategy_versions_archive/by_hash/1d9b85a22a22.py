...
# --- Change History ---
# v501: restore height gradient in axis 8.8 at deadline_crossed — from flat -4500 to
# -2500 - landing_y * 2000. v452/v454 flattened -4500 per protected strategy, but
# protected has NO additive axes (9.6b, 9.6, 5.6, 9.3) that accumulate ~800-1200 at
# high pc+reactive. Flat penalty makes ALL candidates identical → HEIGHT_CONTROL scatter
# to edges → max_y runway (latest game T110-117: 5/8 turns score_delta=0, max_y 2.2→3.03).
# With gradient: y=-2→-2500, y=0→-4500, y=2→-6500. ~4000 swing creates meaningful
# height differentiation while overwhelming additive bonuses across ALL y levels.
# Fixes failure mode: flat penalty kills height differentiation → edge scatter → death
# refs: game_history/latest.jsonl T110-117, game_history/20260425_220312_score2221.jsonl,
