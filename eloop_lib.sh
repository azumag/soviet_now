...
RADIO_SAY_RATE=150
export SAY_AUDIO_DEVICE="${SAY_AUDIO_DEVICE:-BlackHole 2ch}"
...
_pick_radio_theme() {
	local themes=(
		...
		# --- 各国グルメ・文化（追加パック） ---
		"台湾の魯肉飯の話。屋台文化と夜市の熱気、八角香る煮込みの地域差、家庭の味としての定着を深掘りして"
		"ベトナムのフォーの話。北部と南部で違うスープ哲学、フランス植民地期の影響、朝食として愛される理由を深掘りして"
		"シンガポールの海南鶏飯の話。移民が作った国民食、ホーカー文化、チリソースと生姜だれの作法を深掘りして"
		"マレーシアのナシレマの話。ココナッツライスとサンバルの組み合わせ、朝食文化、多民族国家の味の融合を深掘りして"
		"インドネシアのルンダンの話。ミナン文化の祝祭料理、長時間煮込みの保存性、世界人気料理ランキング常連の理由を深掘りして"
		"フィリピンのアドボの話。酢と醤油で煮る家庭料理、植民地史との関係、各家庭で味が違う文化を深掘りして"
		"中国の四川火鍋の話。花椒の痺れ文化、麻辣の快感、鍋を囲む社交スタイルを深掘りして"
		"中国の広東飲茶の話。点心ワゴン文化、朝茶の習慣、家族で卓を囲む週末文化を深掘りして"
		"モンゴルのホーショールの話。遊牧文化と羊肉料理、揚げたての屋台食、ナーダム祭との関係を深掘りして"
		"ネパールのモモの話。チベット圏由来の蒸し餃子、辛いアチャールとの相性、山岳都市の定番軽食文化を深掘りして"
		"パキスタンのニハリの話。夜通し煮込む骨付き肉料理、イスラム祝祭との結びつき、朝に食べる伝統を深掘りして"
		"スリランカのコットゥロティの話。鉄板で刻むリズム料理、屋台の音が街に響く夜文化、スパイス使いの多層性を深掘りして"
		"イランのチェロケバブの話。長粒米文化とサフラン、宮廷料理から大衆食への広がり、炭火焼きの技法を深掘りして"
		"レバノンのメゼの話。小皿を分け合う歓待文化、タブーリやフムスの地域差、会話と食卓の関係を深掘りして"
		"イスラエルのシャクシュカの話。トマトと卵の朝食文化、中東各地との起源議論、パンですくう食べ方を深掘りして"
		"エジプトのコシャリの話。米と豆とパスタの炭水化物三重奏、庶民食としての強さ、屋台の回転率を深掘りして"
		"モロッコのタジンの話。円錐鍋の蒸し煮構造、甘辛の香辛料バランス、家庭と祝祭での役割を深掘りして"
		"チュニジアのクスクスの話。粒立ちを作る手作業文化、ハリッサの辛味設計、地中海交易の影響を深掘りして"
		"ナイジェリアのジョロフライスの話。西アフリカ諸国で続く起源論争、祝いの席の主役、赤い米料理の外交性を深掘りして"
		"ガーナのフフの話。主食をついて伸ばす所作、スープとの食べ方、共同作業としての調理文化を深掘りして"
		"ケニアのニャマチョマの話。炭火焼き肉の集い文化、週末の社交、シンプルな塩味で肉質を活かす哲学を深掘りして"
		"セネガルのチェブジェンの話。魚と米の国民食、家庭ごとの香味競争、都市と漁村をつなぐ料理文化を深掘りして"
		"南アフリカのボボティの話。スパイス肉と卵液の焼き料理、多民族社会の味の混成、家庭料理としての位置づけを深掘りして"
		"ブラジルのフェイジョアーダの話。豆と肉の煮込み、土曜ランチの定番、サンバと食卓の結びつきを深掘りして"
		"ペルーのセビーチェの話。酸で締める海鮮技法、太平洋沿岸の鮮魚文化、国民食としての誇りを深掘りして"
		"アルゼンチンのアサードの話。炭火焼きの週末儀式、肉の部位ごとの焼き分け、会話中心の食卓文化を深掘りして"
		"チリのエンパナーダの話。祝祭で食べる詰め物パイ、具材の地域差、ストリートフードとしての進化を深掘りして"
		"コロンビアのアレパの話。とうもろこし生地の主食文化、朝食から夜食までの汎用性、地方ごとの厚みと具を深掘りして"
		"キューバのロパビエハの話。ほぐし牛肉の煮込み、移民史と家庭料理の接続、米豆と合わせる定番構成を深掘りして"
		"ジャマイカのジャークチキンの話。スコッチボネットとオールスパイス、燻し焼き技法、レゲエと屋外調理文化を深掘りして"
		"カナダのプーティンの話。フライドポテトとグレイビーとカードチーズの背徳三位一体、ケベック発祥論争を深掘りして"
		"アメリカ南部BBQの話。テキサスとカロライナのソース戦争、低温長時間調理、地域アイデンティティとの結びつきを深掘りして"
		"フランスのビストロ文化の話。日替わり定食の哲学、ワインと会話の距離感、街角食堂の社会的役割を深掘りして"
		"イタリアのリゾットの話。北イタリア米文化、アルデンテ管理の職人性、サフラン風味ミラノ風の系譜を深掘りして"
		"スペインのパエリアの話。バレンシア発祥論、鍋底のおこげソカラット礼賛、祝祭で作る大鍋文化を深掘りして"
		"ポルトガルのバカリャウの話。干し鱈の保存食史、365日レシピ神話、大航海時代と塩蔵技術を深掘りして"
		"ドイツのソーセージ文化の話。地方ごとの腸詰め多様性、ビールとの相性設計、屋台と市場の生活動線を深掘りして"
		"オーストリアのシュニッツェルの話。薄く叩く肉料理の技法、ウィーン食文化、帝国時代の食卓の名残を深掘りして"
		"スイスのフォンデュの話。共同鍋で食べる冬の儀式、チーズ産地の個性、山岳地帯の保存食知恵を深掘りして"
		"ベルギーのフリッツの話。二度揚げの理屈、ソース文化の多様性、フライドポテト起源論争を深掘りして"
		"オランダのスタンポットの話。じゃがいも潰し料理の家庭性、寒冷地の主食設計、素朴料理の再評価を深掘りして"
		"イギリスのフィッシュアンドチップスの話。産業革命期の大衆食、ビネガーをかける作法、パブ文化との接点を深掘りして"
		"アイルランドのアイリッシュシチューの話。羊肉と根菜の煮込み、寒冷地の暮らし、家庭ごとに変わる配合を深掘りして"
		"ポーランドのピエロギの話。包み料理の家族行事、具材の甘辛幅、祝日食としての位置づけを深掘りして"
		"チェコのグラーシュの話。中央欧州の煮込み文化、パンとの合わせ方、居酒屋料理としての発展を深掘りして"
		"ハンガリーのグヤーシュの話。パプリカ文化の核、遊牧民料理の系譜、スープ型と煮込み型の違いを深掘りして"
		"ルーマニアのサルマーレの話。キャベツ巻きの祝祭料理、東欧の保存食知恵、家族行事での定番性を深掘りして"
		"ブルガリアのバニツァの話。層状パイ生地の朝食文化、チーズの塩味設計、新年行事との関係を深掘りして"
		"ギリシャのムサカの話。ナスとミートソースとベシャメルの層構造、地中海食文化、家庭レシピの違いを深掘りして"
		"セルビアのチェヴァプチチの話。小型肉串の炭火文化、パンと生玉ねぎの組み合わせ、バルカンの共有料理圏を深掘りして"
		"クロアチアのパシュティツァーダの話。牛肉煮込みの祝祭料理、ダルマチア沿岸の香味設計、長時間調理の伝統を深掘りして"
		"スウェーデンのスモーガスボードの話。冷菜を並べる食卓設計、祝宴の段取り、ニシン料理の位置づけを深掘りして"
		"ノルウェーのルーテフィスクの話。干し鱈保存の知恵、冬の祝祭食としての強い個性、好みが割れる味覚文化を深掘りして"
		"フィンランドのカレリアパイの話。ライ麦生地と卵バターの定番、東部地域の家庭文化、素朴食の再評価を深掘りして"
		"デンマークのスモーブローの話。オープンサンドの美学、具材の重ね順、昼食文化としての完成度を深掘りして"
		"アイスランドのハカールの話。発酵保存食の極北、気候と食材制約が生んだ工夫、伝統継承の現在を深掘りして"
		"オーストラリアのミートパイの話。スポーツ観戦と定番軽食、国民食化の過程、ソースのかけ方論争を深掘りして"
		"ニュージーランドのハンギの話。地熱を使う先住民マオリ料理、共同調理の儀礼性、土地と食の結びつきを深掘りして"
		"ハワイのポケの話。生魚マリネの伝統、移民文化で変化した具材、世界展開で起きた再解釈を深掘りして"
		"メキシコのモーレの話。チョコと唐辛子を使う複雑ソース、地域で違うレシピ体系、祭礼料理としての格を深掘りして"
		"日本のお好み焼きの話。関西と広島で違う構造、鉄板コミュニケーション、粉もの文化の経済性を深掘りして"
		"トルコの朝食文化の話。小皿を並べるカフヴァルトゥ、パンとチーズと紅茶の朝習慣、家族時間としての価値を深掘りして"
		# --- 科学・技術（細分化） ---
		...
		"ブラックナイト衛星の話。1万3000年前から地球を周回しているとされる謎の物体、NASAの写真、正体についての諸説を深掘りして"
		)
