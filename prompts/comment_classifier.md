...
- chitchat: casual conversation not fitting other categories, including short reactions like "へえ", "なるほど", "それな". Do not create a separate short-reaction category. Classify by intent, not length: short questions, corrections, and requests to answer again are not mere reactions. Reply length is handled by the response prompt.
- other: anything else
