...
- Codex/仕組み改善がなければ ===CODEX_ADVICE=== は出力しない
	...
	2. data/voicevox_sing_reference.md を読んで楽譜JSON仕様を確認する
	3. ===SING=== マーカーで楽譜JSONを出力する。曲の指定がない・知らない・難しい場合でも、きらきら星のJSONを必ず出力すること。歌唱リクエストで ===SING=== なしは禁止
	4. 曲の指定がない場合や知らない曲の場合は、きらきら星など簡単な曲でよい
