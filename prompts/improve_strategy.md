...
目的は「ソ連の建国」である。国ピースを併合して、最終レベルのソ連ピースを作る。ソ連はロシアピースを二つ併合する必要があり、ロシアピースはその下のレベルのピースを併合する必要がある。また、「単発の最高スコア」ではなく、直近12試合の中央値・平均の底上げと下振れの減少に注目すること。特にゲームオーバー直前、dead line 付近の立て直し性能を重視する。
