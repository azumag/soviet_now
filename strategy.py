...
def decide(game_state: dict, analysis: dict) -> dict:
    ...
    phase_str = "危機" if is_crisis else "通常"

    return {
        "x": best_result["x"],
        "reason": f"スコア x={best_result['x']:.2f} ({phase_str}, grade={merge_grade}, y={best_result.get('landing_y', -5):.2f}, score={best_score:.0f})",
    }
