...
STATUS_OVERLAY_SOURCE="${OBS_STATUS_OVERLAY_SOURCE:-statusOverlay}"
STATUS_OVERLAY_WIDTH="${STATUS_OVERLAY_WIDTH:-520}"
STATUS_OVERLAY_HEIGHT="${STATUS_OVERLAY_HEIGHT:-980}"
STATUS_OVERLAY_OBS_X="${STATUS_OVERLAY_OBS_X:-24}"
STATUS_OVERLAY_OBS_Y="${STATUS_OVERLAY_OBS_Y:-255}"
STATUS_OVERLAY_OBS_SCALE_X="${STATUS_OVERLAY_OBS_SCALE_X:-0.90}"
STATUS_OVERLAY_OBS_SCALE_Y="${STATUS_OVERLAY_OBS_SCALE_Y:-0.74}"
SHOW_STATUS_OVERLAY_HTML_FILE="$ELOOP_LIB_DIR/$TMP_STATE_DIR/show_status_overlay.html"
SHOW_STATUS_OVERLAY_SOURCE="${OBS_SHOW_STATUS_OVERLAY_SOURCE:-showStatusOverlay}"
SHOW_STATUS_OVERLAY_WIDTH="${SHOW_STATUS_OVERLAY_WIDTH:-520}"
SHOW_STATUS_OVERLAY_HEIGHT="${SHOW_STATUS_OVERLAY_HEIGHT:-980}"
...
IMPROVE_AUDIO_SUMMARY_INTERVAL_SEC="${IMPROVE_AUDIO_SUMMARY_INTERVAL_SEC:-300}"
...
TABU_SIGNATURES_FILE="$TMP_STATE_DIR/tabu_signatures.jsonl"
BEHAVIOR_SIGNATURES_FILE="$TMP_STATE_DIR/behavior_signatures.json"
HASH_HISTORY_INDEX_FILE="$TMP_STATE_DIR/hash_history_index.json"
LAST_ANCHOR_CHANGE_FILE="$TMP_STATE_DIR/last_anchor_change.md"
