...
ZAI_RADIO_TOOLS="${ZAI_RADIO_TOOLS:-default}"
ZAI_COMMENT_TOOLS="${ZAI_COMMENT_TOOLS:-default,WebSearch,WebFetch}"
ZAI_TIMEOUT="${ZAI_TIMEOUT:-180}"

RADIO_AGENT="$ZAI_MODEL"
RADIO_FALLBACK="$ZAI_FALLBACK_MODEL"
