...
REGRESSION_MIN_COMP_GAP=1200
REGRESSION_MIN_P50_GAP=1000
REGRESSION_MIN_P25_GAP=1800
REGRESSION_MIN_BREACH_COUNT=2
BRANCH_MAX_DEPTH=4
BRANCH_MAX_GAMES=$((MIN_GAMES_BEFORE_IMPROVE * 4)) # 4サイクル分 (base: 12*4=48)
BRANCH_PATIENCE=3
BRANCH_HARD_COMP_GAP=2200
BRANCH_HARD_P50_GAP=1800
BRANCH_HARD_P25_GAP=2600
