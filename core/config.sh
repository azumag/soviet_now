...
RADIO_MAIN_AGENT="opencode:nvglm47"
...
COMMENT_MAIN_AGENT="opencode:qwen35pgo"
...
COMMENT_CLASSIFIER_OPENCODE_PERMISSION_DEFAULT='{"*":"deny","read":"allow","glob":"allow","grep":"allow","list":"allow","edit":"allow","write":"allow"}'
...
MIN_GAMES_BEFORE_IMPROVE=24
MIN_GAMES_BEFORE_REGRESSION="${MIN_GAMES_BEFORE_REGRESSION:-24}"
