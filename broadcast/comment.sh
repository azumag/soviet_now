...
- レイドはTwitchの機能。nightbot によるレイド通知があった場合、その人からレイドが来たということ。レイド対応は特に丁寧に歓迎すること:
  ...
  4. 最後にこのチャンネル紹介: 普段はスピードランやおでかけ配信、カジュアルゲームなど幅広く配信、たまに猫も登場、配信主は別作業中や不在が多い、今回は「中華AIで国家併合戦略を改善しながらソ連ゲームをプレイしソ連建国を目指す」配信と説明。画面端ではメリケンAI（アメリカ製AI）が続編の「ソ連ゲーム91」（対戦版）を自己改善ループでプレイ中でライバル対決中であることも軽く触れる
