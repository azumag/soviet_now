...
2. ニュースコーナー
   ...
   - 目安1000字程度で深く語る。ただし言い切ったら短くてもよい。同じ内容の繰り返しで水増ししないこと
...
【本日のニュース】
以下のニュースについて、本文の内容を踏まえて感想・考察・ツッコミを交えてしっかり語ってください。本文が短い・見出しだけ・未取得の場合は、事前調査メモや検索結果から内容を再構成して語ること。その場合も「本文が確認できない」等のメタ説明はしないこと。
...
2. ニュースコーナー
   ...
   - 本文の内容を踏まえて目安1000字程度で深く語る。ただし言い切ったら短くてもよい。同じ内容の繰り返しで水増ししないこと
   - 単なる冷笑やツッコミで終わらせず、「なぜこうなったのか」「この先どうなるのか」「歴史的に見るとどういう位置づけか」など自分なりの洞察や意見を述べる
   - 斜に構えつつも知性を感じさせる分析を
3. 軽いクロージング（1-2文）
