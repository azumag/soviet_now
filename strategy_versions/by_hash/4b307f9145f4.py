...
def decide(game_state: dict, analysis: dict) -> dict:
    ...
    Fix CHAIN_MERGE logic to evaluate merged_type piece density instead of just closest distance.
    This improves chain merge opportunity evaluation accuracy.
